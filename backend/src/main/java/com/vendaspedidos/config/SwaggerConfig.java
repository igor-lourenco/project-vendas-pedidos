...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.vendaspedidos.resources"))
	...
	private ApiInfo apiInfo() {
		 return new ApiInfo(
		 "API do Projeto de sistema de vendas",
		 "Esta API de pedidos com produtos e clientes",
		 "Versão 1.0",
		 "https://www.udemy.com/terms",
		 new Contact("Igor Lourenço", "https://www.linkedin.com/in/igor-lourenco-santos", "igor.lourencosantos@gmail.com"),
